...
namespace Ecosave
{
    public partial class Powerbank : Form
    {
        ...
        private void PowerBanks4_Click(object sender, EventArgs e)
        {
            MessageBox.Show("New Products On The Way Stay Tuned");
        }

        private void PowerBanks5_Click(object sender, EventArgs e)
        {
            MessageBox.Show("New Products On The Way Stay Tuned");
        }

        private void PowerBanks6_Click(object sender, EventArgs e)
        {
            MessageBox.Show("New Products On The Way Stay Tuned");
        }
        ...
        private void PowerBanks2_Click(object sender, EventArgs e)
        {
            if (!Utils.FormIsOpen("Durecopow_Solar_Charger"))
            {
        ...
        private void PowerBanks3_Click(object sender, EventArgs e)
        {
            if (!Utils.FormIsOpen("Takki_83Wh_Portable_Power_Station"))
            {
